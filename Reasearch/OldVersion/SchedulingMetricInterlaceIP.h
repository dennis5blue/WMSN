#ifndef SCHEDULING_METRIC_INTERLACE_IP_H
#define SCHEDULING_METRIC_INTERLACE_IP_H
...
class SchedulingMetricInterlaceIP
{
public:
	SchedulingMetricInterlaceIP(int numCameras, vector< pair<double,double> > positions, vector< vector<int> > overhearTopology);
...
#endif //SCHEDULING_METRIC_INTERLACE_IP_H
