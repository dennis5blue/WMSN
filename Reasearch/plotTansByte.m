...
hold on;
bar([0 0 1616870/(1024*1024) 0 0], 'b','barwidth',0.6,'FaceColor',[0.75,0.75,0]);
hold on;
bar([0 0 0 1672289/(1024*1024) 0], 'c','barwidth',0.6,'FaceColor',[0.75,0.75,0]);
hold on;
...
legend('Independent encoding','MLS','Scheduling metric','Minimum dominating set','Lower bound')
grid on;