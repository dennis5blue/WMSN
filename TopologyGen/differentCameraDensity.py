...
# filename = "/home/dennisyu/Documents/WMSN/TopologyGen/differentCameraDensity.py"
...
cameraPos = (-0.8, 0.0, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.6, 0.0, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.6, -0.4, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.5, -0.7, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-1.0, -0.8, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.1, -0.1, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.5, -0.9, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.2, -0.2, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-0.7, -0.3, 0.1)
cameraRotation = (math.pi*76.0/180, math.pi*0.0/180, -math.pi*90.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
...
c=0;
logFileName="//home/dennisyu/Documents/WMSN/TestSequences/test_paperDensity_1_png/log.txt"
...
# Find cameras that match cameraNames 
    if ( obj.type =='CAMERA'): 
        ...
        RR = "Render Result";
        bpy.data.images[RR].save_render("/home/dennisyu/Documents/WMSN/TestSequences/test_paperDensity_1_png/camera_"+str(c)+".png");
        c = c + 1; 
