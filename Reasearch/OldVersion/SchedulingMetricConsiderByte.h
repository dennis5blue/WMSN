#ifndef SCHEDULING_METRIC_CONSIDER_BYTE_H
#define SCHEDULING_METRIC_CONSIDER_BYTE_H
...
class SchedulingMetricConsiderByte
{
public:
	SchedulingMetricConsiderByte(int numCameras, vector< pair<double,double> > positions, vector< vector<int> > overhearTopology);
...
#endif //SCHEDULING_METRIC_CONSIDER_BYTE_H
