...
c=0;
logFileName="/home/dennisyu/Documents/WMSN/TestSequence/log.txt"
...
# Find cameras that match cameraNames 
    if ( obj.type =='CAMERA'): 
        ...
        RR = "Render Result";
        bpy.data.images[RR].save_render("/home/dennisyu/Documents/WMSN/TestSequence/camera_"+str(c)+".png");
        c = c + 1; 
